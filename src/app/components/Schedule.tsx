...
const days: ScheduleDay[] = [
  {
    ...
    events: [
      { time: '03:00 PM', title: 'Check-in Opens', subtitle: 'Reitz Union Ballroom entrance · badge and swag pickup', type: 'standard' },
      { time: '05:30 PM', title: 'Walk-In Check-in', subtitle: 'Reitz Union Ballroom entrance, until 6:00 PM', type: 'standard' },
      { time: '06:00 PM', title: 'Commencement Ceremony', subtitle: 'Reitz Union Ballroom', type: 'key' },
      { time: '06:05 PM', title: 'Opening Remarks', subtitle: 'Tracks, rules, Discord, and the submission deadline', type: 'standard' },
      { time: '06:15 PM', title: 'Webull', subtitle: 'Sponsor segment', type: 'standard' },
      { time: '06:20 PM', title: 'MLH Segment', subtitle: 'Major League Hacking presentation', type: 'support' },
      { time: '06:35 PM', title: 'Rules Recap, Q&A & Team Formation', subtitle: 'Find teammates in the ballroom', type: 'standard' },
      { time: '06:45 PM', title: 'Hacking Begins', subtitle: 'Data and API access released', type: 'key' },
      { time: '07:00 PM', title: 'Track Office Hours', subtitle: 'Data & API setup help, until 7:30 PM', type: 'support' },
      { time: '07:30 PM', title: 'Dinner Served', subtitle: 'Provided for all participants', type: 'standard' },
      { time: '08:00 PM', title: 'MLH & Webull Workshops', subtitle: 'GitHub Copilot · Webull Open API & paperTrade', type: 'support' },
      { time: '10:00 PM', title: 'Overnight Hacking', subtitle: 'Hacking continues through Saturday morning', type: 'standard' },
    ],
  },
  {
    label: 'Day 2',
    ...
    events: [
      ...
      { time: '10:00 AM', title: 'Speaker Talk', subtitle: 'Speaker to be announced', type: 'support' },
      { time: '11:00 AM', title: 'Sponsor Workshop', subtitle: 'Topic to be announced', type: 'support' },
      { time: '12:00 PM', title: 'Lunch Served', subtitle: 'Provided for all participants', type: 'standard' },
      { time: '01:00 PM', title: 'Speaker Talk', subtitle: 'Speaker to be announced', type: 'support' },
      { time: '02:00 PM', title: 'Advanced Technical Workshop', subtitle: 'Hands-on session', type: 'support' },
      { time: '03:00 PM', title: 'Workshops & Mini-Events', subtitle: 'Hands-on sessions and activities', type: 'support' },
      { time: '04:00 PM', title: 'Mixer with Firm Representatives', subtitle: 'Bring printed resumes', type: 'key' },
      { time: '05:00 PM', title: 'Track Check-ins', subtitle: 'Sign up for a Sunday presentation slot', type: 'standard' },
      ...
      { time: '09:30 PM', title: 'Evening Hacking', subtitle: 'Quant Puzzles leaderboard update', type: 'standard' },
  ...
  },
  {
    ...
    events: [
      ...
      { time: '12:30 PM', title: 'Lunch Served', subtitle: 'Provided for all participants', type: 'standard' },
      { time: '01:00 PM', title: 'Expo & Judging Begins', subtitle: 'Live presentations: 5 minutes + Q&A', type: 'standard' },
      { time: '03:00 PM', title: 'Judging Closes', subtitle: 'Expo concludes', type: 'standard' },
      { time: '03:35 PM', title: 'Closing Ceremony', subtitle: 'Reitz Union Ballroom', type: 'standard' },
      { time: '03:40 PM', title: 'Winners Announced', subtitle: 'Track and sponsor prizes', type: 'key' },
